...
/* ================================================================
    ...
    var THEME_MINIGAME_INTRO = {
        'cyberpunk': {
            ...
            'marginal': { fr: "Ghost vous tire par la manche jusqu'à son coin de ruelle. Sur l'écran de son terminal portatif, un labyrinthe néon clignote : caisses à huître holographiques, boîtes de conserve lustrées, roues de vélo, le tout empilé avec une patience d'orfèvre. « On m'appelle le fantôme. Les ghosts, je les évite. Chaque couloir a sa place, monsieur l'inspecteur. »\n\nIl vous tend une manette. « Votre métier, c'est les mots. Le mien, c'est les couloirs. Si vous savez naviguer un labyrinthe sans vous faire piéger par les fantômes... alors vous avez de la réflexion. Pas juste de la langue. »\n\n« Montrez-moi. Après, je vous dirai ce que j'ai vu, cette nuit-là. »", en: "Ghost tugs your sleeve toward his alley corner. On his portable terminal screen, a neon maze blinks: holographic oyster crates, polished tin cans, bicycle wheels, all stacked with a jeweller's patience. \"They call me the Ghost. The ghosts, I avoid them. Every corridor has its place, mister inspector.\"\n\nHe hands you a controller. \"Your trade is words. Mine is corridors. If you can navigate a maze without letting the ghosts catch you... then you have real thought. Not just a tongue.\"\n\n\"Show me. Then I'll tell you what I saw, that night.\"" },
...
function scrCurrentPhase() { return window.TDPhases[scr.phaseIdx] || null; }
    ...
    function startSelectedMinigame(minigameType, cfg) {
        ...
        if (overlay) {
            overlay.classList.remove('hidden');
            /* Un mini-jeu précédent a pu poser pacman-layout : on repart
               d'un overlay propre. */
            overlay.classList.remove('pacman-layout');
        }
    ...
    function scrFinishMinigameOverlay() {
        ...
        if (overlay) {
            ...
            /* Layout du Pac-Man (colonne de dialogue à gauche) : posé par
               pacman-game.js, il doit tenir jusqu'à la fermeture réelle de
               l'overlay, pas seulement jusqu'à la fin de la partie. */
            overlay.classList.remove('pacman-layout');
