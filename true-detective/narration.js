...
(function (global) {
    ...
    N.act2_3 = {
        ...
        page4: { fr: "Chez Blackwood, le notaire transpire : « Le magnat conservait ses actes de fiducie dans son coffre privé. Si ce coffre a été vidé, je suis ruiné, mais je n'y suis pour rien ! » Sur son bureau, une grille de Puissance 4 encore vierge, tracée à l'encre et à la règle. « Moi, je ne crois qu'aux chiffres. »", en: "At Blackwood's, the notary sweats: \"The magnate kept his trust deeds in his private safe. If that safe was emptied, I'm ruined, but I had nothing to do with it!\" On his desk, a still-blank Connect 4 board, ruled in ink. \"I believe in figures only.\"" },
        ...
        suspect: {
            ...
            rounds2: [
                ...
                },
                {
                    ...
                    response: { fr: "Un rictus. « Le code ? Si je le savais, je l'aurais utilisé avant vous, croyez-moi. Mes chiffres à moi, je les sors d'un carnet, pas d'un coffre. »\n\n[Accès] Il évite la question du code. Ou il dit vrai. Le Connect 4 tranchera.", en: "A grimace. \"The code? If I knew it, I would have used it before you did, believe me. My figures come from a ledger, not a safe.\"\n\n[Opportunity] He dodges the code question. Or he tells the truth. The Connect 4 will settle it." },
                    evidence: 'opportunity'
                }
            ],
            rounds3: [
                {
                    ...
                    response: { fr: "Pour la première fois, Blackwood sourit — un vrai sourire, presque d'amour-propre. « Ah. Enfin quelqu'un qui compte. Vous ne savez pas ce que c'est, inspecteur : dîner après dîner, des hommes qui parlent chevaux et canards. Mon Puissance 4 du matin, lui, ne parle jamais pour ne rien dire. »\n\n[Méthode] Un amoureux des nombres. C'est par là qu'il faudra le prendre.", en: "For the first time, Blackwood smiles — a real smile, almost proud. \"Ah. Finally someone who counts. You have no idea, inspector: dinner after dinner, men talking horses and ducks. My morning Connect 4 never speaks to say nothing.\"\n\n[Method] A lover of numbers. That is how he must be taken." },
                    evidence: 'method'
                },
                {
                    id: 'blk_r3q2',
