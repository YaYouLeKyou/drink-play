...
(function (global) {
    ...
    N.act1_1 = {
        ...
        page3: { fr: "Deux témoignages, deux visages du manoir. Wexford range ses notes. « Hale est trop nerveux, Vivienne trop froide. L'un des deux cache quelque chose — ou tous les deux. Le notaire Blackwood tenait les cordons de la bourse du Duc, et le clochard a vu une ombre dans la ruelle. Allons les découvrir. »", en: "Two testimonies, two faces of the manor. Wexford files away his notes. \"Hale is too nervous, Vivienne too cold. One of them is hiding something — or both. Notary Blackwood held the Duke's purse strings, and the homeless man saw a shadow in the alley. Let's go find out.\"" },
    };
    ...
    N.suspects = {
        ...
        criminel: { fr: "Victor Krane, Criminel de bas étage, exécuteur de sales boulots à la pièce — présent dans le quartier la nuit du crime.", en: "Victor Krane, Low-level criminal, a hired hand for dirty jobs — present in the neighborhood on the night of the crime." }
    };
