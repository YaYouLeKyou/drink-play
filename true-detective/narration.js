...
(function (global) {
    ...
    N.act2_2 = {
        page1: { fr: "Au laboratoire, Whitmore vous tend une clé USB : « Les analyses ADN sont sans appel. L'échantillon B ne correspond à aucun des suspects principaux. »", en: "At the laboratory, Whitmore hands you a USB drive : \"The DNA analyses are conclusive. Sample B does not match any of the main suspects.\"" },
    ...
    N.act3_1 = {
        ...
        page2: { fr: "Les fichiers du coffre contiennent des documents confidentiels : des lettres, des reçus... et des traces d'une liaison que la maison cachait.", en: "The safe's files contain confidential documents : letters, receipts... and traces of an affair the house was hiding." },
    ...
    N.act3_2 = {
        ...
        page2: { fr: "Chez le marginal, Silas Crane, sous pression, avoue : « Blackwood m'a payé pour mentir. Le rôdeur... je ne l'ai pas vu clair, mais il portait un blason. »", en: "At the homeless man's place, Silas Crane, under pressure, confesses : \"Blackwood paid me to lie. The prowler... I didn't see him clearly, but he was wearing a crest.\"" },
    ...
    N.act3_3 = {
        page1: { fr: "Dans la ruelle, vous retrouvez Victor Krane. Il se retourne lentement, mâche un curedent. Il n'a pas l'air pressé.\n\n« Inspecteur. On se revoit. »", en: "In the alley, you find Victor Krane again. He turns slowly, chewing a toothpick. He doesn't look in a hurry.\n\n\"Inspector. We meet again.\"" },
        page2: { fr: "Le téléphone du quartier général sonne. C'est un témoignage : quelqu'un a vu un homme en uniforme de majordome près de la scène vers 22h09.", en: "The phone rings at headquarters. It's a witness testimony : someone saw a man in a butler's uniform near the scene around 10:09pm." },
