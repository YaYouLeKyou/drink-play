...
(function (global) {
    ...
    N.act3_1 = {
        ...
        page2: { fr: "La combinaison grince doucement. Le coffre s'ouvre. À l'intérieur... rien. Plus aucun document. Plus aucun billet. Le coffre a été **VIDÉ**.\n\nWexford fronçe le sourcil : « C'est... impossible. Personne n'a dû pouvoir y entrer sans laisser de traces. »", en: "The combination grinds softly. The safe opens. Inside... nothing. No documents. No bills. The safe was **EMPTIED**.\n\nWexford frowns: \"It's... impossible. No one should have been able to enter without leaving traces.\"" },
        page3: { fr: "Wexford se pencle vers le mur de reconstruction adjacent. « Regardez ce mur. » Il pousse un panneau latéral. Le mur **bascule**, révélant un **compartiment caché** avec des contrats falsifiés et une **lettre signée Wexford**.\n\n« Wexford... », murmurez-vous.", en: "Wexford leans toward the adjacent reconstruction wall. \"Look at this wall.\" He pushes a side panel. The wall **swings** open, revealing a **hidden compartment** with forged contracts and a **letter signed Wexford**.\n\n\"Wexford...\" you mutter." },
        page4: { fr: "Wexford pâlit : « Ces papiers... ils datent de la semaine dernière. » Mais vous savez que la pluie a lavé les empreintes du hall. Personne n'a pu franchir le seuil sans être vu.\n\n« Le coffre a été vidé avant notre arrivée. Quelqu'un connaissait la combinaison. »", en: "Wexford pales: \"Those papers... they date from last week.\" But you know the rain washed the prints from the hall. No one could have crossed the threshold unseen.\n\n\"The safe was emptied before our arrival. Someone knew the combination.\"" }
    };
