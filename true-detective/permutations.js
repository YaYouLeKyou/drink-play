...
(function (global) {
    ...
    PERMUTATIONS['protecteur'] = {
        ...
        heure: '22:09',
        mobile: { fr: 'Jaloux de la liaison entre Vivienne et Pembrooke, Hale a manipule le Duc pour qu\'il engagee Krane contre Pembrooke. L\'arme a tue le Duc, et Hale a orchestre le tout pour eliminer Pembrooke.', en: 'Jealous of the liaison between Vivienne and Pembrooke, Hale manipulated the Duke into hiring Krane against Pembrooke. The weapon killed the Duke, and Hale orchestrated it all to eliminate Pembrooke.' },
        ...
        clues: {
            chemistry: { fr: "L'analyse toxico révèle un poison rare et coûteux, acheté à crédit par un officier criblé de dettes : la trace du fournisseur remonte à l'entourage du Major Hale.", en: "The tox analysis reveals a rare, expensive poison bought on credit by an officer drowning in debt: the supplier's trail leads back to Major Hale's circle." },
            carnet_dechire: { fr: 'Le carnet reconstitue revele des versements reguliers a V.K. (Victor Krane) signes par le Duc. Le Duc a engage Krane pour Pembrooke.', en: 'The rebuilt ledger reveals regular payments to V.K. (Victor Krane) signed by the Duke. The Duke hired Krane for Pembrooke.' },
            ...
            montre_code: { fr: 'INDICE MINEUR : 1981 (coffre). INDICE MAJEUR : l\'aiguille figée à 22h09 - l\'heure du crime. Retenez-la.', en: 'MINOR : 1981 (safe). MAJOR : the hand frozen at 10:09pm - the time of death. Remember it.' },
            coffre_code: { fr: 'Le carnet du coffre (code 1981) : le Duc avait engage Victor Krane pour une elimination. Dernier paiement la veille du meurtre.', en: 'The safe ledger (code 1981): the Duke had hired Victor Krane for an elimination. Last payment the day before the murder.' },
    ...
    PERMUTATIONS['femme-fatale'] = {
        ...
        clues: {
            chemistry: { fr: "L'analyse révèle un poison rare du continent, versé dans le whisky : acheté sous un faux nom, il n'a pu transiter que par les mains de Lady Vivienne.", en: "The analysis reveals a rare continental poison poured into the whisky: bought under a false name, it could only have passed through Lady Vivienne's hands." },
            ...
            montre_code: { fr: 'INDICE MINEUR : 1981 (coffre). INDICE MAJEUR : l\'aiguille figée à 22h09. L\'alibi de théâtre de Vivienne s\'effondre sur cet horaire.', en: 'MINOR : 1981 (safe). MAJOR : the hand frozen at 10:09pm. Vivienne\'s theatre alibi collapses on that hour.' },
    ...
    PERMUTATIONS['criminel'] = {
        ...
        clues: {
            chemistry: { fr: "L'analyse révèle un poison rare manipulé avec une précision professionnelle : les traces sur le flacon désignent des mains d'homme de main, celles de Victor Krane.", en: "The analysis reveals a rare poison handled with professional precision: traces on the vial point to a hired man's hands, Victor Krane's." },
            ...
            montre_code: { fr: 'INDICE MINEUR : 1981 (coffre). INDICE MAJEUR : 22h09 - il fallait un homme déjà sur place à cette heure pour frapper et repartir sans être vu.', en: 'MINOR : 1981 (safe). MAJOR : 10:09pm - it took a man already present at that hour to strike and leave unseen.' },
    ...
    PERMUTATIONS['seducteur'] = {
        ...
        clues: {
            chemistry: { fr: "L'analyse révèle un poison rare d'herboristerie italienne, seul un habitué de la péninsule sait s'en procurer : Pembrooke, tout juste revenu, a eu accès à l'arme du crime.", en: "The analysis reveals a rare Italian herbal poison only a frequent visitor to the peninsula could obtain: Pembrooke, freshly returned, had access to the murder weapon." },
    ...
    PERMUTATIONS['marginal'] = {
        ...
        clues: {
            chemistry: { fr: "L'analyse révèle un poison rare, acheté en micro-doses par un homme aux ressources instables : le registre de la pharmacie pointe Silas Crane.", en: "The analysis reveals a rare poison bought in micro-doses by a man of unstable means: the pharmacist's register points to Silas Crane." },
    ...
    PERMUTATIONS['suspect'] = {
        ...
        clues: {
            chemistry: { fr: "L'analyse révèle un poison rare des herbiers juridiques, dont seul un homme de loi possédait la connaissance : le profil toxique désigne Rupert Blackwood.", en: "The analysis reveals a rare poison from legal herbals, knowledge only a man of law possessed: the tox profile points to Rupert Blackwood." },
            ...
            montre_code: { fr: 'INDICE MINEUR : 1981 (coffre). INDICE MAJEUR : 22h09 - Rupert, qui prétend être parti à 21h30, a eu tout le temps de revenir.', en: 'MINOR : 1981 (safe). MAJOR : 10:09pm - Rupert, who claims he left at 9:30pm, had plenty of time to return.' },
