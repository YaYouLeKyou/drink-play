...
(function (global) {
    ...
    PHASES.push({
        ...
        pages: [
            ...
            clue: { fr: 'Une dette colossale soulignee trois fois, une chevaliere au bord du verre, une menace cachetee aux armes de Blackwood et un recu V.K. au dos signe Rupert. Le vol masquait un creancier qui faisait payer son du par le sang.', en: 'A colossal debt underlined three times, a signet ring on the glass rim, a wax-sealed threat bearing Blackwood\'s crest and a V.K. receipt signed Rupert on the back. The robbery masked a creditor collecting his due in blood.' },
            time: 60,
            sceneImage: null,
            hotspots: [
                    { label: 'A', x: 10.2, y: 62.5, info: { fr: 'Une lettre de menace adressee a mon debiteur le plus cher - arrachee en partie, mais le cachet de cire aux armes de Blackwood est reconnaissable.', en: 'A threat letter addressed to my dearest debtor - partly torn, but Blackwood\'s wax crest is recognizable.' } },
                    { label: 'B', x: 24.0, y: 67.1, info: { fr: 'L encrier intact et la plume seche depuis des heures : l ultime echange de mots eu lieu bien AVANT, a voix basse, autour d une table.', en: 'The inkwell untouched and the pen dry for hours : the last exchange of words happened long BEFORE, whispered, around a table.' } },
                    { label: '1', x: 30.7, y: 55.4, info: { fr: 'Cachet intact, bureau non force : quelqu un de confiance a ouvert. Mais les comptes revelent que ce proche etait un debiteur accule.', en: 'Seal intact, desk unforced : someone trusted opened. But the accounts show this close one was a cornered debtor.' } },
                    { label: '2', x: 37.6, y: 56.4, info: { fr: 'La carafe renversee et un verre au bord marque de la trace d une chevaliere - le sceau de Rupert Blackwood. Il est venu avant.', en: 'The overturned decanter and a rim glass marked by a signet ring - Rupert Blackwood\'s crest. He came before.' } },
                    { label: '3', x: 46.8, y: 56.8, info: { fr: 'Le livre de comptes : la colonne Rupert Blackwood montre une dette enorme, soulignee trois fois, puis une note : a regler avant la fin du mois.', en: 'The ledger : the "Rupert Blackwood" column shows a huge debt, underlined three times, then a note : due before month\'s end.' } },
                    { label: '4', x: 65.2, y: 77.2, info: { fr: 'Le fauteuil renverse et une montre de poche au sol : la victime a recu un visiteur de nuit, a l heure ou l on ne recoit que les creanciers.', en: 'The overturned chair and a pocket watch on the floor : the victim received a night visitor, at the hour one only receives creditors.' } },
                    { label: '5', x: 69.9, y: 82.6, info: { fr: 'La mare de sang face au bureau : frappe par surprise au milieu d une ultime conversation d argent. Pas de lutte - on a frappe debout.', en: 'The pool of blood facing the desk : struck by surprise in a final money conversation. No struggle - struck standing.' } },
                    { label: '6', x: 81.8, y: 84.1, info: { fr: 'Un recu V.K. plie : une forte somme versee pour services - et au dos, l ecriture de l obligataire : Rupert.', en: 'A folded V.K. receipt : a large sum paid for services - and on the back, the debtor\'s handwriting : Rupert.' } }
                ] } },
    ...
    PHASES.push({
        ...
        pages: [
            ...
            { decor: 'residence', npc: 'femme-fatale', interrogation: 'femme-fatale', text: { fr: "Lady Vivienne, d'une voix posée dans le boudoir : « Mon mari avait des ennemis, certes. Mais l'auteur de ce crime… c'est quelqu'un de la maison. »\n\nElle reste de marbre, une tasse de thé à la main. Lady Vivienne vous défie aux échecs. Elle attend votre première question.", en: "Lady Vivienne, in a calm voice in the boudoir: \"My husband had enemies, certainly. But the perpetrator… it's someone from the house.\"\n\nShe remains stone-faced, a teacup in hand. Lady Vivienne challenges you to a game of chess. She waits for your first question." } },
            ...
            { decor: 'residence', text: { fr: "La montre du Duc gît sur la table, brisée. L'aiguille figée indique l'heure. Existe-t-il un code caché dans cette montre ?", en: "The Duke's watch lies on the table, broken. The frozen hand shows the time. Is there a hidden code in this watch?" }, minigame: { type: 'montre_code', time: 45, code: [1, 9, 8, 1], title: { fr: "La Montre du Duc", en: "The Duke's Watch" }, desc: { fr: "Examinez la montre pour trouver l'heure du crime et un code secret.", en: "Examine the watch to find the time of death and a secret code." }, clue: { fr: 'INDICE MINEUR : 1981 (coffre). INDICE MAJEUR : 22h09 - Rupert, qui pretend etre parti a 21h30, a eu tout le temps de revenir.', en: 'MINOR : 1981 (safe). MAJOR : 10:09pm - Rupert, who claims he left at 9:30pm, had plenty of time to return.' }, sceneImage: null }},
            ...
            { decor: 'headquarters', npc: 'detective-partner', text: { fr: "Votre partenaire synthétise : « Les contradictions se confirment. Un ou plusieurs témoignages mentent. Continuez l'enquête. » [ENRICH:clues]", en: "Your partner summarizes: \"The contradictions are confirmed. One or more testimonies are lying. Keep investigating.\" [ENRICH:clues]" } }
        ]
    });
    ...
    PHASES.push({
        ...
        pages: [
            ...
            { decor: 'headquarters', npc: 'detective-partner', text: { fr: "Votre partenaire synthétise : « Le réseau révèle des failles majeures. Deux alibis de panne se recouvrent, une liaison est cachée, et un homme de main agit pour un Intérieur. » [ENRICH:clues]", en: "Your partner summarizes: \"The network reveals major flaws. Two breakdown alibis overlap, an affair is hidden, and a hired hand acts for an insider.\" [ENRICH:clues]" } }
        ]
    });
    ...
    PHASES.push({
        ...
        pages: [
            ...
            { decor: 'alley', npc: 'marginal', interrogation: 'marginal', text: { fr: "Sur le chemin du retour, a la sortie du manoir, dans la ruelle adjacente, Silas Crane grelotte dans un coin. Vous l'abordez doucement.\n\n« T'as une piece, inspecteur ? »\n\nVous lui glissez une monnaie. Silas vous propose de construire une tour. Il se detend, pret a parler.", en: "On the way back, at the manor exit, in the adjacent alley, Silas Crane is shivering in a corner. You approach him gently.\n\n\"Got a coin, inspector?\"\n\nYou slip him some change. Silas proposes building a tower with you. He relaxes, ready to talk." } },
            { decor: 'headquarters', npc: 'detective-partner', text: { fr: "Votre partenaire fait le point : « Ces six dépositions se répondent et se contredisent. Préparez-vous à analyser le réseau complet. » [ENRICH:clues]", en: "Your partner takes stock: \"These six depositions answer and contradict each other. Get ready to analyze the full network.\" [ENRICH:clues]" } },
            ...
            { decor: 'headquarters', npc: 'detective-partner', text: { fr: "Votre partenaire synthétise : « Les contradictions se confirment. Un ou plusieurs témoignages mentent. Continuons. » [ENRICH:clues]", en: "Your partner summarizes: \"The contradictions are confirmed. One or more testimonies are lying. Let's continue.\" [ENRICH:clues]" } }
        ]
    });
    ...
    PHASES.push({
        ...
        pages: [
            ...
            { decor: 'crimeScene', text: { fr: "La combinaison de la montre grince le coffre-fort ouvert. À l'intérieur, des liasses de billets, des contrats, des lettres compromettantes. Le mobile du crime se dessine : argent, dettes, silence.\n\n« Les documents révèlent les versements à V.K. et les dettes de Hale. »", en: "The watch's combination grinds open the safe. Inside, bundles of banknotes, contracts, compromising letters. The motive takes shape: money, debts, silence.\n\n\"The documents reveal the payments to V.K. and Hale's debts.\"" } },
            { decor: 'headquarters', text: { fr: "De retour au QG, Wexford étale les documents du coffre. Mais une note froissée dans le tiroir attire votre attention : une note chiffrée de Victor Krane. « Un cryptogramme », murmure-t-il. « Décodez-le, inspecteur. »", en: "Back at HQ, Wexford spreads the safe's documents. But a crumpled note in the drawer catches your attention: a coded note from Victor Krane. \"A cryptogram,\" he mutters. \"Decode it, inspector.\"" }, minigame: { type: 'cryptogramme', time: 90, evidence: 'mobile', title: { fr: "Le Cryptogramme", en: "The Cryptogram" }, desc: { fr: "Décodez la note chiffrée de Victor Krane pour révéler une complicité.", en: "Decode Victor Krane's coded note to reveal a criminal partnership." }, clue: { fr: "La note de Krane révèle : HALE ENGAGE KRANE. La complicité est établie.", en: "Krane's note reveals: HALE HIRES KRANE. The collusion is proven." } } },
        ]
    });
    ...
    PHASES.push({
        ...
        pages: [
            ...
            { decor: 'headquarters', npc: 'detective-partner', text: { fr: "Votre partenaire synthétise : « Les contradictions se confirment. Trois menteurs se dessinent. Le commanditaire n'est jamais celui qui accomplit le geste. » [ENRICH:clues]", en: "Your partner summarizes: \"The contradictions are confirmed. Three liars emerge. The mastermind is never the one who commits the act.\" [ENRICH:clues]" } }
        ]
    });
    ...
    PHASES.push({
        ...
        pages: [
            ...
            ], choiceKey: 'choisirSuspect', text: { fr: "Au quartier général, le moment est venu. Votre partenaire étale les six dossiers sur la table, à côté des documents du coffre. Qui interrogez-vous en premier ?", en: "At headquarters, the time has come. Your partner spreads the six files on the table, beside the safe's documents. Who do you interrogate first?" } },
            ...
            ], choiceKey: 'accuser', text: { fr: "Au quartier général, le moment est venu. Votre partenaire étale les six dossiers sur la table, à côté des documents du coffre. Qui accusez-vous ?", en: "At headquarters, the time has come. Your partner spreads the six files on the table, beside the safe's documents. Who do you accuse?" } }
        ]
    });
