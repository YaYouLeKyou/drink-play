...
(function (global) {
    ...
    PHASES.push({
        ...
        music: 'theme',
        pages: [
            { decor: 'universeSherlock', text: { fr: "La ville respire sous la pluie. Les réverbères percent la brume de leurs halos jaunes, les fiacres glissent sur les pavés mouillés, et dans les ruelles, les ombres sont plus longues que les visages. Une cité qui ne pardonne pas l'erreur. Ce soir, elle vous attend.", en: "The city breathes under the rain. Streetlamps pierce the fog with yellow halos, cabs slide on wet cobblestones, and in the alleys, shadows are longer than faces. A city that does not forgive mistakes. Tonight, it waits for you." } },
    ...
    PHASES.push({
        ...
        music: 'recherche',
        pages: [
            { decor: 'crimeScene', npc: 'detective-partner', text: { fr: "Le manoir est plongé dans une pénombre épaisse. Les rideaux tirés ne laissent passer que des rais de lumière blafarde. Wexford allume une torche et balaie la pièce du regard.\n\n« Chaque détail compte. Je reste là si vous avez besoin. »", en: "The manor is plunged in thick half-light. The drawn curtains let through only wan rays of light. Wexford switches on a torch and sweeps the room.\n\n\"Every detail counts. I'll be here if you need me.\"" } },
            { decor: 'crimeScene',
    ...
    PHASES.push({
        ...
        music: 'recherche',
        pages: [
            { decor: 'residence', npc: 'protecteur', interrogation: 'protecteur', text: { fr: "Au manoir, le Major Hale ajuste ses gants blancs. « Je... je venais simplement m'assurer que le mobilier de sa Seigneurie était intact. Vous savez, il conservait des documents d'une importance capitale dans sa cachette personnelle derrière les boiseries... enfin, ses affaires privées, quoi. Rien qui ne vous regarde. »", en: "At the manor, Major Hale greets you adjusting his white gloves. \"I... I was simply making sure his Lordship's furniture was untouched. You know, he kept documents of the utmost importance in his personal hiding place behind the paneling... well, his private affairs, really. Nothing that concerns you.\"" } },
