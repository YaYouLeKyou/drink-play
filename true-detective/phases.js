...
(function (global) {
    ...
    PHASES.push({
        ...
        music: 'stress',
        pages: [
            { decor: 'alley', npc: 'criminel', interrogation: 'criminel', text: { fr: "Dans la ruelle, vous retrouvez Victor Krane. Il se retourne lentement, mâche un curedent. Il n'a pas l'air pressé.\n\n« Inspecteur. On se revoit. »", en: "In the alley, you find Victor Krane again. He turns slowly, chewing a toothpick. He doesn't look in a hurry.\n\n\"Inspector. We meet again.\"" } },
