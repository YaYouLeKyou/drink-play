...
(function (global) {
    ...
    PHASES.push({
        ...
        pages: [
            ...
            { decor: 'residence', minigame: { type: 'timeline', time: 40, order: [
             ...
             ], title: { fr: "La Chronologie", en: "The Timeline" }, desc: { fr: "Reconstituez la chronologie de la soirée, du dîner à la minute fatale.", en: "Rebuild the evening's timeline, from dinner to the fatal minute." }, clue: { fr: "La chronologie révèle le trou : Hale prétendait dépanner Pembrooke à 22h, mais le rôdeur et le verrou le placent sur les lieux à 22h09.", en: "The timeline reveals the gap : Hale claimed to be helping Pembrooke at 10pm, but the prowler and the lock place him on scene at 10:09pm." } }},
            { decor: 'residence', npc: 'detective-partner', text: { fr: "La chronologie est claire : Hale prétendait être avec Pembrooke à 22h, mais les indices le placent sur les lieux à 22h09. Continuons l'enquête.", en: "The timeline is clear : Hale claimed to be with Pembrooke at 10pm, but the clues place him on scene at 10:09pm. Let's continue the investigation." } },
    ...
    PHASES.push({
        ...
        music: 'enigme',
        pages: [
            { decor: 'headquarters', npc: 'detective-partner', text: { fr: "Au quartier général, votre partenaire recompte les indices. « Les analyses ADN parleront d'elles-mêmes. Mais d'abord, reconstituons ce carnet. »", en: "At headquarters, your partner tallies the clues. \"The DNA analyses will speak for themselves. But first, let's reassemble this ledger.\"" } },
            { decor: 'headquarters', minigame: { type: 'carnet_dechire', time: 50, title: { fr: "Le Carnet déchiré", en: "The Torn Ledger" }, desc: { fr: "Reconstituez les pages arrachées du livre de comptes pour révéler un versement à « V.K. ».", en: "Reassemble the torn ledger pages to reveal a payment to V.K.." }, clue: { fr: "Des versements réguliers à Victor Krane et les empreintes du Major Hale, garde du corps et majordome en chef, sur la mention V.K.", en: "Regular payments to Victor Krane and the fingerprints of Major Hale, bodyguard and chief butler, on the V.K. mention." } } },
            { decor: 'barInterieur', npc: 'seducteur', interrogation: 'seducteur', text: { fr: "A l'interieur du bar, la fumee stagne sous les neons. Vous vous installez au comptoir, a cote de Julian Pembrooke.\n\n- Monsieur Pembrooke. On vous a vu avec la victime la veille de sa mort. Comment l'expliquez-vous ?\n\nPembrooke fait tourner son verre sans y porter les levres. Il vous regarde par-dessous, un sourire en coin.", en: "Inside the bar, smoke lingers under the neon lights. You sit at the counter, next to Julian Pembrooke.\n\n- Mr. Pembrooke. You were seen with the victim the day before his death. How do you explain that ?\n\nPembrooke spins his glass without raising it to his lips. He glances at you from under his brow, a wry smile." } },
            { decor: 'headquarters', npc: 'detective-partner', text: { fr: "De retour au QG, votre partenaire aligne le carnet reconstitué et les premieres analyses. « Les versements a ce V.K. sont le fil rouge de l'affaire. Mais il nous manque une clef, inspecteur - une clef a quatre chiffres. Passons au laboratoire, les analyses nous en diront plus. »", en: "Back at HQ, your partner lines up the reassembled ledger and the first analyses. \"The payments to that V.K. are the thread running through the case. But we're missing a key, inspector - a four-digit key. Let's head to the laboratory, the analyses will tell us more.\"" } },
        ]
    });
    ...
    PHASES.push({
        ...
        pages: [
            ...
            { decor: 'headquarters', npc: 'detective-partner', text: { fr: "Wexford aligne les dépositions déjà recueillies sur le tableau. « Ces six témoignages se répondent, parfois mal. Préparez-vous à analyser le réseau complet. »", en: "Wexford lines up the depositions already gathered on the board. \"These six testimonies answer each other, sometimes poorly. Get ready to analyze the full network.\"" } },
            { decor: 'headquarters', minigame: { type: 'reseau_alibis', time: 90, evidence: 'witness', title: { fr: "Le Réseau d'alibis", en: "The Alibi Network" }, desc: { fr: "Six dépositions. Toutes se répondent ou se contredisent. Cliquez sur chaque carte : Mensonge ou Vérité. Identifiez les menteurs.", en: "Six testimonies. They all answer or contradict each other. Click each card : Lie or Truth. Identify the liars." }, clue: { fr: "Le réseau complet avant le laboratoire révèle des contradictions entre les versions des six suspects.", en: "The complete network before the laboratory reveals contradictions between the versions of the six suspects." }, testimonies: [
                { id: 'hale', witness: { fr: "Major Hale", en: "Major Hale" }, statement: { fr: "J'étais en panne avec Pembrooke à 22h. Le verrou du manoir a été ouvert avec une clé, pas forcé. La victime n'a pas opposé de résistance.", en: "I was broken down with Pembrooke at 10pm. The manor lock was opened with a key, not forced. The victim didn't resist." }, isLie: false },
                { id: 'vivienne', witness: { fr: "Lady Vivienne", en: "Lady Vivienne" }, statement: { fr: "J'étais au théâtre avec des amies, puis seule au manoir. Mon mari et moi avions une relation basée sur l'argent, pas l'amour, je n'avais aucune raison de le tuer.", en: "I was at the theatre with friends, then alone at the manor. My husband and I had a relationship based on money, not love, I had no reason to kill him." }, isLie: true },
            ...
            { decor: 'headquarters', npc: 'detective-partner', text: { fr: "Wexford synthétise : « Les contradictions se confirment. Un ou plusieurs témoignages mentent. Continuons. »", en: "Wexford summarizes: \"The contradictions are confirmed. One or more testimonies are lying. Let's continue.\"" } }
        ]
    });
    ...
    PHASES.push({
        ...
        pages: [
            ...
            { decor: 'crimeScene', minigame: { type: 'coffre_code', time: 40, evidence: 'mobile', title: { fr: "Le Coffre-fort", en: "The Safe" }, desc: { fr: "Entrez le code à 4 chiffres relevé sur la montre pour ouvrir le coffre du magnat.", en: "Enter the 4-digit code taken from the watch to open the magnate's safe." }, clue: { fr: "Le coffre s'ouvre sur des documents compromettants qui révèlent le mobile du crime.", en: "The safe opens on compromising documents that reveal the motive for the crime." } } },
            { decor: 'crimeScene', npc: 'detective-partner', text: { fr: "Le coffre s'ouvre dans un grincement métallique. À l'intérieur, des liasses de billets, des contrats, des lettres compromettantes. Le mobile du crime se dessine : argent, dettes, silence.\n\n« Bien joué, inspecteur. Maintenant, retournons au QG. Il est temps de confronter les suspects. »", en: "The safe opens with a metallic creak. Inside, bundles of banknotes, contracts, compromising letters. The motive takes shape: money, debts, silence.\n\n\"Well done, inspector. Now, back to HQ. It's time to confront the suspects.\"" } }
        ]
    });
