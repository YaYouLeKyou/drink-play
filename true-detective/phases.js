...
(function (global) {
    ...
    PHASES.push({
        ...
        pages: [
            ...
            clue: { fr: "Les indices forensiques peignent un tableau précis : le meurtre a été commis par un proche, le bureau a été sondé mais pas saccagé, et la victime a été frappée sans temps de réagir. Le mobile est désormais établi.", en: "The forensic clues paint a clear picture: the murder was committed by someone close, the desk was searched but not ransacked, and the victim was struck without time to react. The motive is now established." },
            time: 60,
            sceneImage: "assets/image true detective/lieux/classic/scene de crime manoir.png",
            hotspots: [
            { label: 'A', x: 11.6, y: 66.1, evidence: 'opportunity', info: { fr: "Le sceau en or et son cachet, posés à l'extrémité gauche du bureau. Le matériel de correspondance est intact, ce qui prouve que le bureau n'a pas été saccagé au hasard : l'intrus connaissait les lieux, ou possédait les clés.", en: "The gold seal and its stamp, set at the far left of the desk. The correspondence tools are untouched, proving the desk was not ransacked at random: the intruder knew the premises or had the keys." } },
            { label: 'B', x: 24.1, y: 70.4, evidence: 'timeline', info: { fr: "L'encrier central et son bloc d'écriture. Situé au cœur du bureau, il marque la zone où la victime rédigeait ses documents quand l'altercation a éclaté — le crime l'a surpris en pleine écriture.", en: "The central inkwell and its writing block, at the heart of the desk. It marks the spot where the victim was drafting documents when the altercation erupted — the crime caught him mid-sentence." } },
            { label: '1', x: 31.2, y: 56.8, evidence: 'forensic', info: { fr: "Des papiers administratifs et une plume ouverte, éparpillés sur le coin gauche du bureau. Quelqu'un a fouillé les dossiers à la hâte, cherchant un document précis avant de confronter la victime.", en: "Administrative papers and an open quill scattered on the left corner of the desk. Someone rifled through the files in haste, searching for a specific document before confronting the victim." } },
            { label: '2', x: 38.6, y: 57.3, evidence: 'witness', info: { fr: "Deux verres de vin dressés avec une petite coupelle. La victime attendait un proche de confiance pour partager un dernier verre — l'assassin passait pour un visiteur attendu.", en: "Two wine glasses still standing with a small saucer beside them. The victim was expecting a trusted guest for a last drink — the killer passed himself off as an expected visitor." } },
            { label: '3', x: 47.2, y: 58.3, evidence: 'opportunity', info: { fr: "Un livre ouvert, taché de sang, près de la lampe de bureau. Le registre est maculé d'encre et de sang, comme si la lutte avait éclaté au moment même où la victime consultait ces pages.", en: "An open book, stained with blood, near the desk lamp. The ledger is marked with ink and blood, as if the struggle erupted while the victim was consulting these very pages." } },
            { label: '4', x: 66.4, y: 79.2, evidence: 'opportunity', info: { fr: "Le fauteuil de bureau, renversé sur le tapis, près du corps. Une bousculade brève mais violente l'a précipité — la victime a été frappée sans temps de réagir.", en: "The office chair, overturned on the carpet near the body. A brief but violent shove brought him down — the victim was struck before he could react." } },
            { label: '5', x: 70.8, y: 85.6, evidence: 'forensic', info: { fr: "Une trace de sang sèche s'étend du bureau vers la silhouette à la craie. C'est l'épicentre exact de l'agression : aucune blessure de défense ne témoigne d'une lutte, la victime connaissait son agresseur.", en: "A dried blood trail extends from the desk to the chalk outline. It marks the exact epicentre of the attack: no defensive wounds show a struggle, the victim knew his assailant." } },
            { label: '6', x: 78.2, y: 86.3, evidence: 'mobile', info: { fr: "Des papiers éparpillés sur le parquet, à côté du corps. Un fragment de lettre presque illisible glisse parmi les papiers, le dernier élément à examiner pour reconstituer l'histoire du crime.", en: "Scattered papers on the floorboards, beside the body. A nearly illegible letter fragment slips among them, the last element to examine to reconstruct the crime's story." } }
            ] } },
