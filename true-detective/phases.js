...
(function (global) {
    ...
    PHASES.push({
        ...
        pages: [
            ...
            { decor: 'alley', npc: 'marginal', interrogation: 'marginal', text: { fr: "Dans la mansarde misérable de Silas Crane, une unique ampoule nue oscille au bout d'un fil. Il ricanne en toussant.\n\n« La police qui vient voir le mendiant... Vous cherchez des coupables riches ? Vous devriez regarder ce que les riches cachent derrière leurs tableaux. J'ai vu des gens entrer et sortir de son bureau en plein milieu de la nuit, lorgnant sur ce satané coffre mural comme des corbeaux sur une charogne. »", en: "In Silas Crane's miserable garret, a single bare bulb swings on its wire. He snickers, coughing.\n\n\"The police coming to see the beggar... You're looking for rich culprits? You should look at what the rich hide behind their paintings. I've seen people going in and out of his office in the middle of the night, eyeing that damned wall safe like crows on carrion.\"" } },
            { decor: 'alley', npc: 'criminel', interrogation: 'criminel', text: { fr: "Dans la ruelle sombre battue par la pluie, Krane ricane en crachant par terre, toisant les enquêteurs.\n\n« Mon ADN sur place ? C'est le jeu, l'inspecteur. Mais si vous cherchez du grabuge, demandez-vous plutôt ce qui a disparu de son coffre-fort personnel. Un contrat de cette envergure, ça ne se laisse pas traîner au milieu d'un salon sans être enfermé sous double clef. »", en: "In the dark rain-beaten alley, Krane snickers, spitting on the ground, eyeing the investigators.\n\n\"My DNA at the scene? That's the game, inspector. But if you're looking for trouble, ask yourself what disappeared from his personal safe. A contract of that magnitude doesn't get left out in a sitting room without being locked under double key.\"" } }
        ]
    });
    ...
    PHASES.push({
        ...
        pages: [
            ...
            { decor: 'headquarters', npc: 'detective-partner', minigame: { type: 'reseau_alibis', time: 120, evidence: 'witness', title: { fr: "Le Réseau d'alibis", en: "The Alibi Network" }, desc: { fr: "Six dépositions. Toutes s'accusent ou se contredisent. Cliquez sur chaque carte : Mensonge ou Vérité. Identifiez les 3 menteurs.", en: "Six testimonies. They accuse each other or contradict. Click each card : Lie or Truth. Identify the 3 liars." }, clue: { fr: "Le réseau complet révèle trois menteurs qui se couvrent mutuellement. Chaque mensonge pointe vers une complicité. Le commanditaire se dessine.", en: "The full network reveals three liars covering for each other. Each lie points to collusion. The mastermind takes shape." }, testimonies: [
