...
(function (global) {
    ...
    PHASES.push({
        ...
        pages: [
            ...
            { decor: 'laboratory', npc: 'scientifique', text: { fr: "Au laboratoire, Whitmore feuillette ses notes : « Une dernière chose — le rapport toxicologique ne montre aucune trace de lutte. La victime n'a pas opposé de résistance. Elle connaissait son agresseur. »", en: "At the laboratory, Whitmore flips through his notes : \"One last thing — the toxicology report shows no sign of a struggle. The victim didn't resist. She knew her assailant.\"" } }
        ]
    });
