...
(function (global) {
    ...
    PHASES.push({
        ...
        pages: [
            ...
            { decor: 'dynamic', npc: 'dynamic', interrogation: 'dynamic', finalInterrogation: true, text: { fr: "Dernier interrogatoire. Le suspect est placé face aux résultats de l'ADN, au coffre et à la chronologie. Avant la bataille navale, vous avez une dernière chance de faire parler ses contradictions.\n\n« Vous croyez qu'un damier peut vous donner raison ? Il vous donnera surtout la façon dont vous réagirez. »", en: "Final interrogation. The suspect is confronted with the DNA results, the safe and the timeline. Before the battleship duel, you have one last chance to make the contradictions speak.\n\n\"You think a grid will prove you right? It will show how you react instead.\"" } },
